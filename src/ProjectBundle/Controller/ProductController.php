...
class ProductController extends Controller
{
	...
	public function indexAction(Request $request)
    {
        ...
        $response = $this->render('ProjectBundle:'.$this->container->getParameter('view_product').':index.html.twig', array(
	...
	public function seriesAction(Request $request, $id)
    {
        ...
        $response = $this->render('ProjectBundle:'.$this->container->getParameter('view_product').':series.html.twig', array(
            'series'=>$series,
			'products'=>$products,
        ));
	...
	public function detailAction(Request $request, $id)
	{
		...
		$series = null;
		$all_seriess = $product->getSeries();
		if($all_seriess){
			foreach ($all_seriess as $tmp_series) {
				$series = $tmp_series;
				break;
			}
		}
		...
		$response = $this->render('ProjectBundle:'.$this->container->getParameter('view_product').':detail.html.twig', array(
