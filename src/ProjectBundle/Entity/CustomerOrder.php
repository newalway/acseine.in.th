 ...
 *                   @ORM\Index(name="customer_order_order_failed_1", columns={"failed"}),
...
class CustomerOrder
{
    ...
    */
    ...
    /** @ORM\Column(name="failed", type="smallint", options={"unsigned":true, "default":0}) */
    private $failed = 0;
    ...
    /**
     * @ORM\OneToOne(targetEntity="CustomerPaymentOmise", mappedBy="customerOrder")
     */
    private $customerPaymentOmise;

    /**
     * @ORM\OneToOne(targetEntity="CustomerPaymentLinepay", mappedBy="customerOrder")
     */
    private $customerPaymentLinepay;
    ...
    /**
     * @ORM\Column(name="omise_token", type="string", length=255, nullable = true)
     */
    private $omiseToken;

    /**
	* @ORM\Column(name="transaction_locale", type="string", length=255, nullable = true)
	*/
    ...
    /**
     * Get the value of Omise Token
     *
     * @return mixed
     */
    public function getOmiseToken()
    {
        return $this->omiseToken;
    }

    /**
     * Set the value of Omise Token
     *
     * @param mixed omiseToken
     *
     * @return self
     */
    public function setOmiseToken($omiseToken)
    {
    ...
    /**
     * Get the value of Customer Payment Omise
     *
     * @return mixed
     */
    public function getCustomerPaymentOmise()
    {
        return $this->customerPaymentOmise;
    }

    /**
     * Set the value of Customer Payment Omise
     *
     * @param mixed customerPaymentOmise
     *
     * @return self
     */
    public function setCustomerPaymentOmise($customerPaymentOmise)
    {
        $this->customerPaymentOmise = $customerPaymentOmise;
    ...
    /**
     * Get the value of Customer Payment Linepay
     *
     * @return mixed
     */
    public function getCustomerPaymentLinepay()
    {
        return $this->customerPaymentLinepay;
    }

    /**
     * Set the value of Customer Payment Linepay
     *
     * @param mixed customerPaymentLinepay
     *
     * @return self
     */
    public function setCustomerPaymentLinepay($customerPaymentLinepay)
    {
        $this->customerPaymentLinepay = $customerPaymentLinepay;

        return $this;
    }

    /**
     * Get the value of Transaction Locale
     *
     * @return mixed
     */
    ...
    /**
     * Set the value of Transaction Locale
     *
     * @param mixed transactionLocale
     *
     * @return self
     */
